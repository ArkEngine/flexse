...
#pragma pack(4)
    ...
    public:
        ...
        unsigned long long asDate() const {
            const unsigned long long* tmpDate = reinterpret_cast<const unsigned long long*>(&i);
            return tmpDate[0];
        }
        long long asLL() const {
            const unsigned long long* tmpLL = reinterpret_cast<const unsigned long long*>(&i);
            return tmpLL[0];
        }
